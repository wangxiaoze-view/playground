...
app.mount('#app');`,
    cdn: {
      ...
      unpkg: [
        ...
        { type: 'script', url: '@primeuix/themes/umd/aura.js' },
      ],
      jsdelivr: [
        { type: 'script', url: onGetVue3Cdn.jsdelivr },
        { type: 'script', url: 'primevue@4' },
...
app.mount('#app');`,
    cdn: {
      ...
      unpkg: [
        ...
        { type: 'script', url: 'dayjs/dayjs.min.js' },
        { type: 'script', url: 'dayjs/plugin/customParseFormat.js' },
        { type: 'script', url: 'dayjs/plugin/weekday.js' },
        { type: 'script', url: 'dayjs/plugin/localeData.js' },
        { type: 'script', url: 'dayjs/plugin/weekOfYear.js' },
        { type: 'script', url: 'dayjs/plugin/weekYear.js' },
        { type: 'script', url: 'dayjs/plugin/advancedFormat.js' },
        { type: 'script', url: 'dayjs/plugin/quarterOfYear.js' },
        { type: 'script', url: onGetVue3Cdn.unpkg },
